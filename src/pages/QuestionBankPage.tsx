  ...
  return (
    <AppShell>
      <section className="page-heading">
        <div><span className="eyebrow">Obsah hry</span><h1>Overené otázky</h1><p>Do hry sa dostanú iba slušné otázky s dohľadateľným zdrojom.</p></div>
        <button className="button button--secondary" onClick={exportQuestions}><Download size={18} /> Exportovať JSON</button>
      </section>
      <div className="quality-note"><ShieldCheck /><div><strong>Family-friendly štandard</strong><span>Bez 18+ obsahu, vulgarizmov, dvojzmyslov a vymyslených prieskumov. Body pri faktických otázkach sú transparentné herné hodnoty.</span></div></div>
        ...
        {visible.map((question, index) => (
          <article className="question-card" key={question.id}>
            ...
            <div className="question-card__body">
              <div className="question-card__meta"><span>{question.category}</span><span className="verified"><Check size={13} /> Overené</span></div>
